...
package com.tan.yolo.tensorflow;
...
public class TensorFlowImageClassifier implements Classifier {
    ...
    public List<Recognition> recognizeImage(final Bitmap bitmap) {
        ...
        for (int i = 0; i < intValues.length; ++i) {
            ...
            floatValues[i * 3 + 0] = (((val >> 16) & 0xFF) - imageMean) / imageStd;//Red
            floatValues[i * 3 + 1] = (((val >> 8) & 0xFF) - imageMean) / imageStd;//Green
            floatValues[i * 3 + 2] = ((val & 0xFF) - imageMean) / imageStd;//Blue
        }
                ...
                new PriorityQueue<Recognition>(
                        ...
                        new Comparator<Recognition>() {
                            ...
                            public int compare(Recognition lhs, Recognition rhs) {
                                ...
                                return Float.compare(rhs.getConfidence(), lhs.getConfidence()); //a-b =0, negative, positive
                            }
                        });
